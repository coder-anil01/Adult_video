...
const Homepage = () => {
  ...
  const [progress, setProgress] = useState(0)
    ...
    const apiLink = `https://www.eporner.com/api/v2/video/search/?query=${query}&per_page=30&page=${page}&thumbsize=big&order=top-weekly&gay=${gay}&lq=${quality}&format=json`
    useEffect(()=>{
    const getData = async()=>{
      setProgress(70)
